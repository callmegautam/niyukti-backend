...
export const updateUserSchema = z.object({
    ...
    githubUrl: z
        ...
        .max(
            MAX_URL_LENGTH,
            `GithubUrl is too long (max ${MAX_URL_LENGTH} characters)`
        ),
    ...
    resumeUrl: z
        ...
        .max(
            MAX_URL_LENGTH,
            `ResumeUrl is too long (max ${MAX_URL_LENGTH} characters)`
        ),
    ...
    avatarUrl: z
        ...
        .max(
            MAX_URL_LENGTH,
            `AvatarUrl is too long (max ${MAX_URL_LENGTH} characters)`
        ),
